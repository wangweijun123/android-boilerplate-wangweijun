...
public class GameFragment extends BaseFragment implements GameMvpView{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View homeView = View.inflate(getActivity(), R.layout.fragment_game, null);
    ...
    private void getRankApps() {
        ...
        if (isVisibleToUser && root != null && !isLoading && gameAdapter != null && !gameAdapter.hasData()) {
            gamePresenter.getRankApps();
        }
    }
